...
Token* getToken(void) 
{
  ...
  case 3:
    ...
    return getToken();
  case 4:
    int checkKeyW = checkKeyword(str);
    if (checkKeyW == TK_NONE) state = 5; else state = 6;
    return getToken();
  case 5:
  ...
  case 7:
    ...
    while (currentChar != EOF && charCodes[currentChar] == CHAR_DIGIT) {
      if (idx >= 10) {
        while (currentChar != EOF && charCodes[currentChar] == CHAR_DIGIT) readChar();
    ...
    if (idx == 0) strcpy(token->string, "0");
    else strcpy(token->string, string);
    return token;
  case 9:
	readChar();
  ...
  case 16:
    readChar();
    if ((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) state = 17; else state = 18;
    return getToken();
  case 17:
  ...
  case 20:
    ...
    cn = colNo;
    readChar();
    if ((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) state = 21; else state = 22;
    return getToken();
  case 21:
    readChar();
  ...
  case 24:
    readChar();
    if ((currentChar != EOF) && (charCodes[currentChar] == CHAR_RPAR)) state = 25; else state = 26;
    return getToken();
  case 25:
  ...
  case 28:
    readChar();
    if ((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) state = 29; else state = 30;
    return getToken();
  case 29:
  ...
  case 34:
  	...
  	return makeToken(TK_NONE, lineNo, colNo-2);
  ...
  case 37:
    ...
    if (currentChar == EOF) state = 40; else state = 38;
    return getToken();
  case 38:
    while ((currentChar != EOF) && (charCodes[currentChar] == CHAR_TIMES)) readChar();
    if (currentChar == EOF) state = 40; else if (charCodes[currentChar] == CHAR_RPAR) state = 39; else state = 37;
    return getToken();
  case 39:
    state = 0;
    readChar();
